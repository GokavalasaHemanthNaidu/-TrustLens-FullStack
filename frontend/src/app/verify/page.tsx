...
export default function VerifyForensicPage() {
  ...
  useEffect(() => {
    const user = localStorage.getItem("PramanaChain_user");
    if (!user) {
      router.push("/");
    }
  }, [router]);
      ...
      getDetails: (data: VerifyImageResponse) => {
        ...
        if (status === "authentic") {
          ...
          return {
            ...
            badge: "Not Found",
            points: [
              "Warning: No matching record anchor found in the immutable PramanaChain ledger.",
                        ...
                        <p className="text-xs text-slate-300 max-w-3xl leading-relaxed">
                          {forensicData.ledger_comparison.status === "authentic"
                            ...
                            : forensicData.ledger_comparison.status === "tampered"
                              ...
                              : "Danger: This document was never registered in the PramanaChain immutable ledger! The genesis fingerprint is unrecognized. This scan is likely a complete fabrication."}
                        </p>
                      </div>
                    </div>
