...
export default function Dashboard() {
  ...
  useEffect(() => {
    const userJson = localStorage.getItem("PramanaChain_user");
    if (!userJson) {
      router.push("/");
      return;
    }
        ...
        {loading ? (
          <div className="space-y-6">
            ...
            <div className="rounded-2xl border border-white/5 bg-slate-900/40 p-8 backdrop-blur-xl animate-pulse h-96 flex flex-col items-center justify-center">
              ...
              <p className="text-slate-400 text-sm font-medium">Securing connection to the PramanaChain ledger...</p>
            </div>
          </div>
        ) : error ? (
            ...
            <div className="mt-16 pt-16 border-t border-white/5">
              <div className="max-w-3xl mx-auto space-y-8">
                <div className="text-center space-y-2">
                  ...
                  <p className="text-slate-400">Verify the authenticity of any document across the entire PramanaChain network by entering its cryptographic hash or Document ID.</p>
                </div>
